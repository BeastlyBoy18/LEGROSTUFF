...
int main() {
	...
	while (input.compare("quit") != 0 && health > 0) {
		...
		case 1:
			Image = al_load_bitmap("Cell.jpg");
			al_draw_bitmap(Image,1, 50, 0);
			al_flip_display();
			...
			//-----------------------------------------------
		case 2:
			Image = al_load_bitmap("Cell2.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//--------------------------------------------------
		case 3:
			Image = al_load_bitmap("Guardroom.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0)); 
			...
			//-------------------------------------------------------
		case 4:
			Image = al_load_bitmap("Office.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 5:
			Image = al_load_bitmap("Front.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 6:
			Image = al_load_bitmap("Intero.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 7:
			Image = al_load_bitmap("break-room.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 8:
			Image = al_load_bitmap("locker.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 9:
			Image = al_load_bitmap("range.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
			...
			//-------------------------------------------------------
		case 10:
			Image = al_load_bitmap("Sheriff.jpg");
			al_draw_bitmap(Image, 1, 15, 0);
			al_flip_display();
			al_clear_to_color(al_map_rgb(0, 0, 0));
